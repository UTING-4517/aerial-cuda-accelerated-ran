...
function [g] = PucchF34UciMultiplexing(nSym, nSym_dmrs, pi2Bpsk, nSymUci, E_seq1, E_seq2, UciSeq1, UciSeq2)
%%
...
% UciSeq1   --> bit sequence 1
% UciSeq2   --> bit sequence 2

% outputs:
% g --> coded bit sequence
%%
...
gBar_lkv = -1 * ones(nPucchSymUci, nSymUci, Qm);
g = -1 * ones(E_seq1 + E_seq2, 1);
