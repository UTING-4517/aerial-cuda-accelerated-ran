...
function ci = compute_check(i,cb,Zc,TannerPar)
...
%tanner paramaters:
nNeighbors = TannerPar.nNeighbors(i);         % number of variable nodes adjacent to i'th check node
NeighborIdx = TannerPar.NeighborIdx{i};       % indicies of variable nodes adjacent to i'th check node. Dim: 1 x numNeighbors
NeighborShift = TannerPar.NeighborShift{i};   % expansion permuations by variable nodes adjacent to i'th check node. Dim: 1 x numNeighbors
