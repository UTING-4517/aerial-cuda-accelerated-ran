...
bfc.nLayers = 16;        % number of downlink layers. Value: 1,2,4,8,16
bfc.L_gNB = 64;          % number of gNB antennas. Value: 2,4,8,16,32,64
bfc.nWeights = 137;%3200;%136;      % number of beamforming weights. Value: 1-136
