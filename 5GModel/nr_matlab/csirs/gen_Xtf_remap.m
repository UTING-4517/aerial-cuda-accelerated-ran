...
function Xtf_remap = gen_Xtf_remap(csirs_cfg, Xtf_remap, csirsTable)

[nCfg, ~] = size(csirs_cfg);

for idxCfg = 1:nCfg
    
    Row = csirs_cfg{idxCfg, 1};
    CDMType = csirs_cfg{idxCfg, 2};
    FreqDensity = csirs_cfg{idxCfg, 3};
    StartRB = csirs_cfg{idxCfg, 4};
    NrOfRBs = csirs_cfg{idxCfg, 5};
    SymbL0 = csirs_cfg{idxCfg, 6};
    SymbL1 = csirs_cfg{idxCfg, 7};
    FreqDomain_bin = cell2mat(csirs_cfg{idxCfg, 8});
