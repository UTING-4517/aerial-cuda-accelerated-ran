...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        uint8_t enableCsiP2Fapiv3 = staticApiDataset.puschStatPrms.enableCsiP2Fapiv3;
        ...
        expandParameters(tbPrmsCpu_buffer.addr(), &staticApiDataset.puschStatPrms, &dynApiDataset.puschDynPrm, cmnPrms, ueGrpPrmsPrime, LDPCprms, enableCsiP2Fapiv3);
