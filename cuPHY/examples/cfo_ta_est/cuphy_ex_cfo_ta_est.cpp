...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        puschRx.expandFrontEndParameters(&dynApiDataset.puschDynPrm, &staticApiDataset.puschStatPrms, drvdUeGrpPrmsCpuBuffer.addr(), subSlotProcessingFrontLoadedDmrsEnabled, maxDmrsMaxLen, enableRssiMeasurement, maxNPrbAlloc);
